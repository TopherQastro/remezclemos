...
def gov(empLine, pLEmps, qLine, qAnteLine, proxExpress):
    ...
    while pLEmps != empLine:
        print('mLF:', gF.lineno(), '| gov() while0 start', qLine)
        result = False
